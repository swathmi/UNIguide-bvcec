...
# ================= MAIN SERVICE =================
def get_eee_department_response(intent):
    ...
    # ---------- HOD ----------
        ...
        return format_lines(
            ...
            [
                ...
                f"Experience: {h['experience_years']} Years"
            ],
            "🎓"
        )
    ...
    # ---------- FACULTY ----------
        ...
        return format_lines("👩‍🏫 Faculty Members", lines, "📚")

    # ---------- VISION & MISSION ----------
    elif intent == "vision_and_mission":
        return format_lines(
            "🎯 Vision & Mission",
            ["Vision:", dept_data["vision"], "Mission:"] + dept_data["mission"],
            "🌟"
        )
    ...
    # ---------- SYLLABUS ----------
    elif intent == "syllabus_links":
        return format_lines(
            "📄 EEE Syllabus PDFs",
            [f"{k}: {v}" for k, v in dept_data["syllabus_links"].items()],
            "🔗"
        )
